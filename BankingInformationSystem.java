...
class Account {
    ...
    public Account(String fName, String lName, int age, int acctype, String dob, String gender, String address,
            String contactNo, String email, int accid, double balance, String passcode) {
        this.fName = fName;
        this.lName = lName;
        this.age = age;
        this.dob = dob;
        ...
        do {
            ...
            switch (s) {
                ...
                case 1:
                    ...
                    while (!first.matches("^[a-zA-z]+") || first == null || first.equals("") || first.isEmpty()
                            || first.length() > 50) {
...
class Menu {
    ...
    public Menu(Scanner sc, Account acc, int lastaccid, ArrayList<Account> accounts) {
        ...
        System.out.println(" ");
        System.out.println(" ");
        System.out.println("                                 Welcome " + acc.getFName() + " " + acc.getLName()
                + " to Bank Information System");
        System.out.println(" ");
        System.out.println("                            <><><><><><><><><><><><><><><><><><><><><><><><><><><><><>");
...
class Main {
    ...
    public Main(Scanner sc, int Lastaccid, ArrayList<Account> accounts) {
        ...
        do {
            ...
            switch (p) {
                case 1:
                    new Reg(sc, Lastaccid, accounts);
                    break;

                case 2:
                    new Log(sc, Lastaccid, accounts);
                    break;
                ...
                case 3:
                    ...
                    System.out.println(
                            "           ------------------------------ being our customer you are a family member of ours------------------------------- ");
                    System.out.println(
...
class Reg {
    ...
    public Reg(Scanner sc, int lastaccid, ArrayList<Account> accounts) {
        ...
        while (!fName.matches("^[a-zA-z]+") || fName == null || fName.equals("") || fName.isEmpty()
                || fName.length() > 50) {
            System.out.print("\nPlease retype Your First Name: ");
            fName = sc.next();
        }
        ...
        Account acc = new Account(fName, lName, age, acctype, dob, gender, address, contactNo, email, id, balance,
                passcode);
        accounts.add(acc);
